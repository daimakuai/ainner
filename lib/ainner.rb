require "ainner/version"
require "ainner/command"
require "ainner/asset"
require "ainner/cache"
require "ainner/helper"
require "ainner/sprite"
require "ainner/archive"
require "ainner/bundler"
require "ainner/reactor"
require "ainner/wrapper"
require "ainner/template"
require "ainner/notifier"
require "ainner/compressor"
require "ainner/environment"
...
module Ainner
  ...
  def config_file
    ainner_file = root.join("Ainnerfile")
    config_file = root.join("config.yml")
    File.exist?(ainner_file) ? ainner_file : config_file
  end
